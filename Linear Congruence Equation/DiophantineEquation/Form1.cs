    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (noError)
            {
                ...
                int congX = newX * dividedEqualsWithGCD;// get the congruence number X
                int tOne, tTwo;
                ...
                textBox4.Text = x + "";
                textBox5.Text = y + "";
               // equals = equals / gcdNum;
                congruenceClasses(newX,numTwo, gcdNum, tTwo);
            }
        }

        private void congruenceClasses(int x, int modNumber,int gcd, int increase)
        {
            string str = "";
            while(x>0)
            {
            ...
            while(x < 0)//finde first positive congruence number
            {
                x += modNumber;
            }
